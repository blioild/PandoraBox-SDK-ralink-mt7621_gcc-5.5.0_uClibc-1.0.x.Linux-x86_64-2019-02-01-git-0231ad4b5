...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/perl5/5.22.1/x86_64-linux-thread-multi'),
    ...
    osname => 'linux',
    osvers => '4.15.0-43-generic',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/perl5/5.22.1'),
    scriptdir => '.../',
    sitearchexp => relocate_inc('.../../lib/perl5/site_perl/5.22.1/x86_64-linux-thread-multi'),
    sitelibexp => relocate_inc('.../../lib/perl5/site_perl/5.22.1'),
    so => 'so',
    useithreads => 'define',
