...
"x86_64-linux-thread-multi-4.15.0-43-generic" or
	die "Errno architecture (x86_64-linux-thread-multi-4.15.0-43-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
