...
/* macros for field cf_paprd_train_segment */
#define PAPRD_TRAINER_CNTL1__CF_PAPRD_TRAIN_SEGMENT__SHIFT                   30
#define PAPRD_TRAINER_CNTL1__CF_PAPRD_TRAIN_SEGMENT__WIDTH                    1
#define PAPRD_TRAINER_CNTL1__CF_PAPRD_TRAIN_SEGMENT__MASK           0x40000000U
#define PAPRD_TRAINER_CNTL1__CF_PAPRD_TRAIN_SEGMENT__READ(src) \
                    (((u_int32_t)(src)\
                    & 0x40000000U) >> 30)
#define PAPRD_TRAINER_CNTL1__CF_PAPRD_TRAIN_SEGMENT__WRITE(src) \
                    (((u_int32_t)(src)\
                    << 30) & 0x40000000U)
#define PAPRD_TRAINER_CNTL1__CF_PAPRD_TRAIN_SEGMENT__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x40000000U) | (((u_int32_t)(src) <<\
                    30) & 0x40000000U)
#define PAPRD_TRAINER_CNTL1__CF_PAPRD_TRAIN_SEGMENT__VERIFY(src) \
                    (!((((u_int32_t)(src)\
                    << 30) & ~0x40000000U)))
#define PAPRD_TRAINER_CNTL1__CF_PAPRD_TRAIN_SEGMENT__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x40000000U) | ((u_int32_t)(1) << 30)
#define PAPRD_TRAINER_CNTL1__CF_PAPRD_TRAIN_SEGMENT__CLR(dst) \
                    (dst) = ((dst) &\
...
#define PAPRD_TRAINER_CNTL1__READ                                   0xcff83fffU
#define PAPRD_TRAINER_CNTL1__WRITE                                  0xcff83fffU
...
/* macros for BlueprintGlobalNameSpace::chn_dc_notch_fd_01_mem */
#ifndef __CHN_DC_NOTCH_FD_01_MEM_MACRO__
#define __CHN_DC_NOTCH_FD_01_MEM_MACRO__

/* macros for field dc_notch_fd_coeff */
#define CHN_DC_NOTCH_FD_01_MEM__DC_NOTCH_FD_COEFF__SHIFT                      0
#define CHN_DC_NOTCH_FD_01_MEM__DC_NOTCH_FD_COEFF__WIDTH                     12
#define CHN_DC_NOTCH_FD_01_MEM__DC_NOTCH_FD_COEFF__MASK             0x00000fffU
#define CHN_DC_NOTCH_FD_01_MEM__DC_NOTCH_FD_COEFF__READ(src) \
                    (u_int32_t)(src)\
                    & 0x00000fffU
#define CHN_DC_NOTCH_FD_01_MEM__DC_NOTCH_FD_COEFF__WRITE(src) \
                    ((u_int32_t)(src)\
                    & 0x00000fffU)
#define CHN_DC_NOTCH_FD_01_MEM__DC_NOTCH_FD_COEFF__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000fffU) | ((u_int32_t)(src) &\
                    0x00000fffU)
#define CHN_DC_NOTCH_FD_01_MEM__DC_NOTCH_FD_COEFF__VERIFY(src) \
                    (!(((u_int32_t)(src)\
                    & ~0x00000fffU)))
#define CHN_DC_NOTCH_FD_01_MEM__TYPE                                  u_int32_t
#define CHN_DC_NOTCH_FD_01_MEM__READ                                0x00000fffU
#define CHN_DC_NOTCH_FD_01_MEM__WRITE                               0x00000fffU

#endif /* __CHN_DC_NOTCH_FD_01_MEM_MACRO__ */


/* macros for chn_table_map.BB_chn_dc_notch_fd_01_mem */
#define INST_CHN_TABLE_MAP__BB_CHN_DC_NOTCH_FD_01_MEM__NUM                  256

/* macros for BlueprintGlobalNameSpace::chn_dc_notch_fd_23_mem */
#ifndef __CHN_DC_NOTCH_FD_23_MEM_MACRO__
#define __CHN_DC_NOTCH_FD_23_MEM_MACRO__

/* macros for field dc_notch_fd_coeff */
#define CHN_DC_NOTCH_FD_23_MEM__DC_NOTCH_FD_COEFF__SHIFT                      0
#define CHN_DC_NOTCH_FD_23_MEM__DC_NOTCH_FD_COEFF__WIDTH                     12
#define CHN_DC_NOTCH_FD_23_MEM__DC_NOTCH_FD_COEFF__MASK             0x00000fffU
#define CHN_DC_NOTCH_FD_23_MEM__DC_NOTCH_FD_COEFF__READ(src) \
                    (u_int32_t)(src)\
                    & 0x00000fffU
#define CHN_DC_NOTCH_FD_23_MEM__DC_NOTCH_FD_COEFF__WRITE(src) \
                    ((u_int32_t)(src)\
                    & 0x00000fffU)
#define CHN_DC_NOTCH_FD_23_MEM__DC_NOTCH_FD_COEFF__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000fffU) | ((u_int32_t)(src) &\
                    0x00000fffU)
#define CHN_DC_NOTCH_FD_23_MEM__DC_NOTCH_FD_COEFF__VERIFY(src) \
                    (!(((u_int32_t)(src)\
                    & ~0x00000fffU)))
#define CHN_DC_NOTCH_FD_23_MEM__TYPE                                  u_int32_t
#define CHN_DC_NOTCH_FD_23_MEM__READ                                0x00000fffU
#define CHN_DC_NOTCH_FD_23_MEM__WRITE                               0x00000fffU

#endif /* __CHN_DC_NOTCH_FD_23_MEM_MACRO__ */


/* macros for chn_table_map.BB_chn_dc_notch_fd_23_mem */
#define INST_CHN_TABLE_MAP__BB_CHN_DC_NOTCH_FD_23_MEM__NUM                  256
...
#define TIERED_CHN_TABLE_MAP__VERSION \
                    ...
                    /prj/qca/chips/besra/1.0/shanghai-qca/dev_01/tyzhang/tyzhang_besra_chip/chips/besra/1.0/src/chip_top/design/blueprint/srcs/chn_table_map.rdl"
