...
#ifndef __OTP_LAYOUT_QCA9888_H__
#define __OTP_LAYOUT_QCA9888_H__
...
Define_Otp_Offset(END,0x3FF);
Define_Otp_Size(MAX,0x400);
...
//-- Section 2
Define_Otp_Offset(ANTI_ROLLBACK_COUNTER,0x3C3);
Define_Otp_Offset(OEM_ID_COMPLEMENT,0x3C7);
Define_Otp_Offset(OEM_ID,0x3C9);
Define_Otp_Offset(OEM_PRODUCT_FEATURE_CONTROL,0x3CB);
...
#define OTP_TAIL_RESERVED_BYTES    108 /* At tail, for ATE */


#endif // __OTP_LAYOUT_QCA9888_H__
