/* seafile-object.h generated by valac 0.32.0-dirty, the Vala compiler, do not modify */
...
void seafile_repo_set_last_modify (SeafileRepo* self, gint64 value);
...
void seafile_repo_set_last_modifier (SeafileRepo* self, const gchar* value);
...
void seafile_repo_set_last_modified (SeafileRepo* self, gint64 value);
...
gint64 seafile_repo_get_last_sync_time (SeafileRepo* self);
void seafile_repo_set_last_sync_time (SeafileRepo* self, gint64 value);
...
void seafile_trash_repo_set_encrypted (SeafileTrashRepo* self, gboolean value);
...
gint64 seafile_deleted_entry_get_delete_time (SeafileDeletedEntry* self);
void seafile_deleted_entry_set_delete_time (SeafileDeletedEntry* self, gint64 value);
...
void seafile_commit_set_client_version (SeafileCommit* self, const gchar* value);
...
void seafile_file_count_info_set_file_count (SeafileFileCountInfo* self, gint64 value);
gint64 seafile_file_count_info_get_dir_count (SeafileFileCountInfo* self);
void seafile_file_count_info_set_dir_count (SeafileFileCountInfo* self, gint64 value);
gint64 seafile_file_count_info_get_size (SeafileFileCountInfo* self);
void seafile_file_count_info_set_size (SeafileFileCountInfo* self, gint64 value);
