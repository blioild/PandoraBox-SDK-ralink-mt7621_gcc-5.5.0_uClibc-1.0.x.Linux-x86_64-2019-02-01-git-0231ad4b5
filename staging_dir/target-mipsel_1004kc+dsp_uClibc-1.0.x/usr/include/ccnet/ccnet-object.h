/* ccnet-object.h generated by valac 0.32.0-dirty, the Vala compiler, do not modify */
...
void ccnet_email_user_set_reference_id (CcnetEmailUser* self, const gchar* value);
