...
#define __GMP_CC "mipsel-openwrt-linux-uclibc-gcc"
#define __GMP_CFLAGS "-Os -pipe -mno-branch-likely -mips32r2 -mtune=1004kc -mlong-calls -mdsp -fno-caller-saves -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -msoft-float -iremap/home/lintel/PandoraBox-MT7621/build_dir/target-mipsel_1004kc+dsp_uClibc-1.0.x/gmp-6.0.0:gmp-6.0.0 -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -fpic "
