...
define KernelPackage/crypto-qcrypto
  ...
  DEPENDS:=@TARGET_qualcomm +kmod-crypto-manager +kmod-crypto-aes +kmod-crypto-hash +kmod-crypto-des
  $(call AddDepends/crypto)
endef
