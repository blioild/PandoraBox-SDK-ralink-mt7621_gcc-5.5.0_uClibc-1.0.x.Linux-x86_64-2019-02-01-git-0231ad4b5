...
I2C_QUP_MODULES:=\
  CONFIG_I2C_QUP:drivers/i2c/busses/i2c-qup

define KernelPackage/i2c-qup
  $(call i2c_defaults,$(I2C_QUP_MODULES),59)
  TITLE:=IPQ806x Platform I2C interface support
  DEPENDS:=@TARGET_qualcomm_ipq806x +kmod-i2c-core
endef

define KernelPackage/i2c-qup/description
 Kernel module for I2C interface on the IPQ806x
 family processors
endef

$(eval $(call KernelPackage,i2c-qup))

I2C_MSM_MODULES:=\
  CONFIG_I2C_MSM_V2:drivers/i2c/busses/i2c-msm_v2

define KernelPackage/i2c-msm
  $(call i2c_defaults,$(I2C_MSM_MODULES),59)
  TITLE:=IPQ806x Platform I2C interface support
  DEPENDS:=@TARGET_qualcomm_ipq806x +kmod-i2c-core
endef

define KernelPackage/i2c-msm/description
 Kernel module for I2C interface on the IPQ806x
 family processors
endef

$(eval $(call KernelPackage,i2c-msm))
