...
define KernelPackage/rtc-pcf8523/description
 Kernel module for NXP PCF8523 RTC chip.
endef
...
define KernelPackage/regmap
  ...
  DEPENDS:=@!LINUX_3_4 +kmod-lib-lzo +kmod-i2c-core 
  KCONFIG:=CONFIG_REGMAP \
	   CONFIG_REGMAP_SPI \
	   CONFIG_REGMAP_I2C \
	   CONFIG_REGMAP_SPMI=n \
	   CONFIG_REGMAP_MMIO \
	   CONFIG_REGMAP_IRQ=y \
	   CONFIG_SPI=y
  FILES:= \
...
define KernelPackage/echo
  ...
  KCONFIG:=CONFIG_ECHO
ifeq ($(strip $(call CompareKernelPatchVer,$(KERNEL_PATCHVER),le,3.16.0)),1)
