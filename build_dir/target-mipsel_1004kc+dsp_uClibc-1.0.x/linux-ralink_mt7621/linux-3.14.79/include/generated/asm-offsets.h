...
#define TASK_MM 448 /* offsetof(struct task_struct, mm)	 # */
#define TASK_PID 520 /* offsetof(struct task_struct, pid)	 # */
#define TASK_STACK_CANARY 528 /* offsetof(struct task_struct, stack_canary)	 # */
#define TASK_STRUCT_SIZE 1608 /* sizeof(struct task_struct)	 # */
...
#define THREAD_REG16 784 /* offsetof(struct task_struct, thread.reg16)	 # */
#define THREAD_REG17 788 /* offsetof(struct task_struct, thread.reg17)	 # */
#define THREAD_REG18 792 /* offsetof(struct task_struct, thread.reg18)	 # */
#define THREAD_REG19 796 /* offsetof(struct task_struct, thread.reg19)	 # */
#define THREAD_REG20 800 /* offsetof(struct task_struct, thread.reg20)	 # */
#define THREAD_REG21 804 /* offsetof(struct task_struct, thread.reg21)	 # */
#define THREAD_REG22 808 /* offsetof(struct task_struct, thread.reg22)	 # */
#define THREAD_REG23 812 /* offsetof(struct task_struct, thread.reg23)	 # */
#define THREAD_REG29 816 /* offsetof(struct task_struct, thread.reg29)	 # */
#define THREAD_REG30 820 /* offsetof(struct task_struct, thread.reg30)	 # */
#define THREAD_REG31 824 /* offsetof(struct task_struct, thread.reg31)	 # */
#define THREAD_STATUS 828 /* offsetof(struct task_struct, thread.cp0_status)	 # */
#define THREAD_FPU 832 /* offsetof(struct task_struct, thread.fpu)	 # */
...
#define THREAD_FPR0 832 /* offsetof(struct task_struct, thread.fpu.fpr[0])	 # */
#define THREAD_FPR1 840 /* offsetof(struct task_struct, thread.fpu.fpr[1])	 # */
#define THREAD_FPR2 848 /* offsetof(struct task_struct, thread.fpu.fpr[2])	 # */
#define THREAD_FPR3 856 /* offsetof(struct task_struct, thread.fpu.fpr[3])	 # */
#define THREAD_FPR4 864 /* offsetof(struct task_struct, thread.fpu.fpr[4])	 # */
#define THREAD_FPR5 872 /* offsetof(struct task_struct, thread.fpu.fpr[5])	 # */
#define THREAD_FPR6 880 /* offsetof(struct task_struct, thread.fpu.fpr[6])	 # */
#define THREAD_FPR7 888 /* offsetof(struct task_struct, thread.fpu.fpr[7])	 # */
#define THREAD_FPR8 896 /* offsetof(struct task_struct, thread.fpu.fpr[8])	 # */
#define THREAD_FPR9 904 /* offsetof(struct task_struct, thread.fpu.fpr[9])	 # */
#define THREAD_FPR10 912 /* offsetof(struct task_struct, thread.fpu.fpr[10])	 # */
#define THREAD_FPR11 920 /* offsetof(struct task_struct, thread.fpu.fpr[11])	 # */
#define THREAD_FPR12 928 /* offsetof(struct task_struct, thread.fpu.fpr[12])	 # */
#define THREAD_FPR13 936 /* offsetof(struct task_struct, thread.fpu.fpr[13])	 # */
#define THREAD_FPR14 944 /* offsetof(struct task_struct, thread.fpu.fpr[14])	 # */
#define THREAD_FPR15 952 /* offsetof(struct task_struct, thread.fpu.fpr[15])	 # */
#define THREAD_FPR16 960 /* offsetof(struct task_struct, thread.fpu.fpr[16])	 # */
#define THREAD_FPR17 968 /* offsetof(struct task_struct, thread.fpu.fpr[17])	 # */
#define THREAD_FPR18 976 /* offsetof(struct task_struct, thread.fpu.fpr[18])	 # */
#define THREAD_FPR19 984 /* offsetof(struct task_struct, thread.fpu.fpr[19])	 # */
#define THREAD_FPR20 992 /* offsetof(struct task_struct, thread.fpu.fpr[20])	 # */
#define THREAD_FPR21 1000 /* offsetof(struct task_struct, thread.fpu.fpr[21])	 # */
#define THREAD_FPR22 1008 /* offsetof(struct task_struct, thread.fpu.fpr[22])	 # */
#define THREAD_FPR23 1016 /* offsetof(struct task_struct, thread.fpu.fpr[23])	 # */
#define THREAD_FPR24 1024 /* offsetof(struct task_struct, thread.fpu.fpr[24])	 # */
#define THREAD_FPR25 1032 /* offsetof(struct task_struct, thread.fpu.fpr[25])	 # */
#define THREAD_FPR26 1040 /* offsetof(struct task_struct, thread.fpu.fpr[26])	 # */
#define THREAD_FPR27 1048 /* offsetof(struct task_struct, thread.fpu.fpr[27])	 # */
#define THREAD_FPR28 1056 /* offsetof(struct task_struct, thread.fpu.fpr[28])	 # */
#define THREAD_FPR29 1064 /* offsetof(struct task_struct, thread.fpu.fpr[29])	 # */
#define THREAD_FPR30 1072 /* offsetof(struct task_struct, thread.fpu.fpr[30])	 # */
#define THREAD_FPR31 1080 /* offsetof(struct task_struct, thread.fpu.fpr[31])	 # */
#define THREAD_FCR31 1088 /* offsetof(struct task_struct, thread.fpu.fcr31)	 # */
...
#define VCPU_ARCH_SIZE 2384 /* sizeof(struct kvm_vcpu_arch)	 # */
