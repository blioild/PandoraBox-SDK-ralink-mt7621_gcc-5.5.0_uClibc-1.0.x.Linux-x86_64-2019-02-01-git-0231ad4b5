...
#define SURFBOARDINT_UART2        SURFBOARDINT_UART_LITE3
...
#define SURFBOARDINT_UART2       SURFBOARDINT_UART_LITE3 //ttyS2
...
#define SURFBOARDINT_GPIO_IRQS_START	64
#define SURFBOARDINT_GPIO_IRQS_END 	128
